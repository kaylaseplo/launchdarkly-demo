...
export declare function defaultHeaders(sdkKey: string, info: Info, tags?: ApplicationTags, includeAuthorizationHeader?: boolean, userAgentHeaderName?: 'user-agent' | 'x-launchdarkly-user-agent', instanceId?: string): LDHeaders;
